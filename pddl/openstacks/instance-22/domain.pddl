(define (domain socs2025_openstacks_7-domain)
 (:requirements :strips :typing :numeric-fluents :durative-actions)
 (:types order product)
 (:constants
   p7 p2 p10 p1 p5 p11 p3 p6 p8 p9 p4 - product
   o2 o3 o10 o11 o6 o1 o4 o7 o5 o9 o8 - order
 )
 ...
 (:durative-action make_product_p1
  ...
  :condition (and (at start (not_made p1))(at start (started o1))(at start (started o2))(at start (started o7))(at start (started o8))(at start (started o9)))
  :effect (and (at start (not (not_made p1))) (at end (made p1))))
 (:durative-action make_product_p2
  :parameters ()
  :duration (= ?duration 30)
  :condition (and (at start (not_made p2))(at start (started o3)))
  :effect (and (at start (not (not_made p2))) (at end (made p2))))
 (:durative-action make_product_p3
  :parameters ()
  :duration (= ?duration 60)
  :condition (and (at start (not_made p3))(at start (started o2)))
 ...
 (:durative-action make_product_p5
  ...
  :condition (and (at start (not_made p5))(at start (started o6)))
 ...
 (:durative-action make_product_p7
  ...
  :condition (and (at start (not_made p7))(at start (started o6))(at start (started o10)))
  :effect (and (at start (not (not_made p7))) (at end (made p7))))
 (:durative-action make_product_p8
  :parameters ()
  :duration (= ?duration 30)
  :condition (and (at start (not_made p8))(at start (started o3))(at start (started o11)))
  :effect (and (at start (not (not_made p8))) (at end (made p8))))
 (:durative-action make_product_p9
  :parameters ()
  :duration (= ?duration 70)
  :condition (and (at start (not_made p9))(at start (started o4)))
 ...
 (:durative-action make_product_p11
  :parameters ()
  :duration (= ?duration 30)
  :condition (and (at start (not_made p11))(at start (started o4)))
 ...
 (:durative-action ship_order_o6
  :parameters ()
  :duration (= ?duration 1)
  :condition (and (at start (started o6))(at start (made p5))(at start (made p7)))
  :effect (and (at start (not (started o6))) (at end (shipped o6)) (at end (decrease (stacks_in_use) 1))))
 (:durative-action ship_order_o7
  :parameters ()
  :duration (= ?duration 1)
  :condition (and (at start (started o7))(at start (made p1))(at start (made p4))(at start (made p6)))
