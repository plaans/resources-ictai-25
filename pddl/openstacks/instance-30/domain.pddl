(define (domain socs2025_openstacks_2-domain)
 (:requirements :strips :typing :numeric-fluents :durative-actions)
 (:types order product)
 (:constants
   p3 p4 p6 p2 p1 p5 - product
   o6 o1 o2 o4 o3 o5 - order
 )
 ...
 (:durative-action make_product_p4
  :parameters ()
  :duration (= ?duration 60)
  :condition (and (at start (not_made p4))(at start (started o1))(at start (started o2)))
  :effect (and (at start (not (not_made p4))) (at end (made p4))))
 (:durative-action make_product_p5
  :parameters ()
  :duration (= ?duration 70)
  :condition (and (at start (not_made p5))(at start (started o3)))
