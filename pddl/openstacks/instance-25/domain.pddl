(define (domain socs2025_openstacks_11-domain)
 (:requirements :strips :typing :numeric-fluents :durative-actions)
 (:types order product)
 (:constants
   p7 p12 p14 p2 p10 p1 p5 p11 p3 p6 p8 p15 p9 p4 p13 - product
   o2 o3 o10 o11 o12 o15 o13 o6 o1 o14 o4 o7 o5 o9 o8 - order
 )
 ...
 (:durative-action make_product_p1
  ...
  :condition (and (at start (not_made p1))(at start (started o13)))
 ...
 (:durative-action make_product_p3
  :parameters ()
  :duration (= ?duration 30)
  :condition (and (at start (not_made p3))(at start (started o7)))
 ...
 (:durative-action make_product_p5
  :parameters ()
  :duration (= ?duration 40)
  :condition (and (at start (not_made p5))(at start (started o9)))
  :effect (and (at start (not (not_made p5))) (at end (made p5))))
 (:durative-action make_product_p6
  :parameters ()
  :duration (= ?duration 30)
  :condition (and (at start (not_made p6))(at start (started o5))(at start (started o6))(at start (started o7)))
  :effect (and (at start (not (not_made p6))) (at end (made p6))))
 (:durative-action make_product_p7
  :parameters ()
  :duration (= ?duration 70)
  :condition (and (at start (not_made p7))(at start (started o13)))
  :effect (and (at start (not (not_made p7))) (at end (made p7))))
 (:durative-action make_product_p8
  :parameters ()
  :duration (= ?duration 60)
  :condition (and (at start (not_made p8))(at start (started o1))(at start (started o3))(at start (started o5))(at start (started o12)))
  :effect (and (at start (not (not_made p8))) (at end (made p8))))
 (:durative-action make_product_p9
  :parameters ()
  :duration (= ?duration 90)
  :condition (and (at start (not_made p9))(at start (started o9))(at start (started o14)))
 ...
 (:durative-action make_product_p11
  :parameters ()
  :duration (= ?duration 60)
  :condition (and (at start (not_made p11))(at start (started o8))(at start (started o10)))
  :effect (and (at start (not (not_made p11))) (at end (made p11))))
 (:durative-action make_product_p12
  :parameters ()
  :duration (= ?duration 40)
  :condition (and (at start (not_made p12))(at start (started o9))(at start (started o11)))
  :effect (and (at start (not (not_made p12))) (at end (made p12))))
 (:durative-action make_product_p13
  :parameters ()
  :duration (= ?duration 80)
  :condition (and (at start (not_made p13))(at start (started o15)))
  :effect (and (at start (not (not_made p13))) (at end (made p13))))
 (:durative-action make_product_p14
  :parameters ()
  :duration (= ?duration 90)
  :condition (and (at start (not_made p14))(at start (started o15)))
  :effect (and (at start (not (not_made p14))) (at end (made p14))))
 (:durative-action make_product_p15
  :parameters ()
  :duration (= ?duration 10)
  :condition (and (at start (not_made p15))(at start (started o2))(at start (started o15)))
 ...
 (:durative-action ship_order_o2
  :parameters ()
  :duration (= ?duration 1)
  :condition (and (at start (started o2))(at start (made p10))(at start (made p15)))
  :effect (and (at start (not (started o2))) (at end (shipped o2)) (at end (decrease (stacks_in_use) 1))))
 (:durative-action ship_order_o3
  :parameters ()
  :duration (= ?duration 1)
  :condition (and (at start (started o3))(at start (made p8)))
 ...
 (:durative-action ship_order_o5
  :parameters ()
  :duration (= ?duration 1)
  :condition (and (at start (started o5))(at start (made p6))(at start (made p8)))
