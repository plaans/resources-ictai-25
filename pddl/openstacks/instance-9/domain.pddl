(define (domain socs2025_openstacks_16-domain)
 (:requirements :strips :typing :numeric-fluents :durative-actions)
 (:types order product)
 (:constants
   p19 p7 p12 p17 p2 p10 p4 p6 p15 p13 p20 p14 p1 p5 p11 p3 p8 p9 p18 p16 - product
   o2 o10 o15 o18 o20 o16 o6 o1 o17 o3 o11 o12 o19 o13 o14 o4 o7 o5 o9 o8 - order
 )
 ...
 (:durative-action make_product_p1
  ...
  :condition (and (at start (not_made p1))(at start (started o17)))
  :effect (and (at start (not (not_made p1))) (at end (made p1))))
 (:durative-action make_product_p2
  :parameters ()
  :duration (= ?duration 10)
  :condition (and (at start (not_made p2))(at start (started o1)))
  :effect (and (at start (not (not_made p2))) (at end (made p2))))
 (:durative-action make_product_p3
  :parameters ()
  :duration (= ?duration 70)
  :condition (and (at start (not_made p3))(at start (started o2))(at start (started o12)))
  :effect (and (at start (not (not_made p3))) (at end (made p3))))
 (:durative-action make_product_p4
  :parameters ()
  :duration (= ?duration 10)
  :condition (and (at start (not_made p4))(at start (started o2))(at start (started o8))(at start (started o9))(at start (started o10)))
  :effect (and (at start (not (not_made p4))) (at end (made p4))))
 (:durative-action make_product_p5
  :parameters ()
  :duration (= ?duration 80)
  :condition (and (at start (not_made p5))(at start (started o2))(at start (started o3)))
  :effect (and (at start (not (not_made p5))) (at end (made p5))))
 (:durative-action make_product_p6
  :parameters ()
  :duration (= ?duration 30)
  :condition (and (at start (not_made p6))(at start (started o3))(at start (started o13)))
 ...
 (:durative-action make_product_p8
  :parameters ()
  :duration (= ?duration 80)
  :condition (and (at start (not_made p8))(at start (started o3)))
  :effect (and (at start (not (not_made p8))) (at end (made p8))))
 (:durative-action make_product_p9
  :parameters ()
  :duration (= ?duration 50)
  :condition (and (at start (not_made p9))(at start (started o18)))
  :effect (and (at start (not (not_made p9))) (at end (made p9))))
 (:durative-action make_product_p10
  :parameters ()
  :duration (= ?duration 80)
  :condition (and (at start (not_made p10))(at start (started o5))(at start (started o10)))
 ...
 (:durative-action make_product_p12
  ...
  :condition (and (at start (not_made p12))(at start (started o7))(at start (started o8))(at start (started o11))(at start (started o15)))
  :effect (and (at start (not (not_made p12))) (at end (made p12))))
 (:durative-action make_product_p13
  :parameters ()
  :duration (= ?duration 50)
  :condition (and (at start (not_made p13))(at start (started o8)))
 ...
 (:durative-action make_product_p15
  :parameters ()
  :duration (= ?duration 20)
  :condition (and (at start (not_made p15))(at start (started o19))(at start (started o20)))
  :effect (and (at start (not (not_made p15))) (at end (made p15))))
 (:durative-action make_product_p16
  :parameters ()
  :duration (= ?duration 90)
  :condition (and (at start (not_made p16))(at start (started o4))(at start (started o6))(at start (started o15)))
  :effect (and (at start (not (not_made p16))) (at end (made p16))))
 (:durative-action make_product_p17
  :parameters ()
  :duration (= ?duration 50)
  :condition (and (at start (not_made p17))(at start (started o8)))
  :effect (and (at start (not (not_made p17))) (at end (made p17))))
 (:durative-action make_product_p18
  :parameters ()
  :duration (= ?duration 30)
  :condition (and (at start (not_made p18))(at start (started o14))(at start (started o15)))
  :effect (and (at start (not (not_made p18))) (at end (made p18))))
 (:durative-action make_product_p19
  :parameters ()
  :duration (= ?duration 30)
  :condition (and (at start (not_made p19))(at start (started o20)))
