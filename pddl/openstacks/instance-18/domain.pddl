(define (domain socs2025_openstacks_9-domain)
 (:requirements :strips :typing :numeric-fluents :durative-actions)
 (:types order product)
 (:constants
   p7 p12 p2 p10 p1 p5 p11 p3 p6 p8 p9 p4 p13 - product
   o2 o3 o10 o11 o12 o13 o6 o1 o4 o7 o5 o9 o8 - order
 )
 ...
 (:durative-action make_product_p3
  ...
  :condition (and (at start (not_made p3))(at start (started o12)))
  :effect (and (at start (not (not_made p3))) (at end (made p3))))
 (:durative-action make_product_p4
  :parameters ()
  :duration (= ?duration 30)
  :condition (and (at start (not_made p4))(at start (started o8))(at start (started o10))(at start (started o12)))
  :effect (and (at start (not (not_made p4))) (at end (made p4))))
 (:durative-action make_product_p5
  :parameters ()
  :duration (= ?duration 30)
  :condition (and (at start (not_made p5))(at start (started o4)))
  :effect (and (at start (not (not_made p5))) (at end (made p5))))
 (:durative-action make_product_p6
  :parameters ()
  :duration (= ?duration 20)
  :condition (and (at start (not_made p6))(at start (started o12)))
  :effect (and (at start (not (not_made p6))) (at end (made p6))))
 (:durative-action make_product_p7
  :parameters ()
  :duration (= ?duration 70)
  :condition (and (at start (not_made p7))(at start (started o2))(at start (started o3))(at start (started o5)))
 ...
 (:durative-action make_product_p9
  :parameters ()
  :duration (= ?duration 70)
  :condition (and (at start (not_made p9))(at start (started o4))(at start (started o6)))
  :effect (and (at start (not (not_made p9))) (at end (made p9))))
 (:durative-action make_product_p10
  :parameters ()
  :duration (= ?duration 60)
  :condition (and (at start (not_made p10))(at start (started o1))(at start (started o9))(at start (started o11)))
 ...
 (:durative-action make_product_p12
  ...
  :condition (and (at start (not_made p12))(at start (started o13)))
 ...
 (:durative-action ship_order_o1
  :parameters ()
  :duration (= ?duration 1)
  :condition (and (at start (started o1))(at start (made p10)))
 ...
 (:durative-action ship_order_o3
  :parameters ()
  :duration (= ?duration 1)
  :condition (and (at start (started o3))(at start (made p7)))
  :effect (and (at start (not (started o3))) (at end (shipped o3)) (at end (decrease (stacks_in_use) 1))))
 (:durative-action ship_order_o4
  :parameters ()
  :duration (= ?duration 1)
  :condition (and (at start (started o4))(at start (made p5))(at start (made p9)))
 ...
 (:durative-action ship_order_o6
  :parameters ()
  :duration (= ?duration 1)
  :condition (and (at start (started o6))(at start (made p9))(at start (made p11)))
  :effect (and (at start (not (started o6))) (at end (shipped o6)) (at end (decrease (stacks_in_use) 1))))
 (:durative-action ship_order_o7
  :parameters ()
  :duration (= ?duration 1)
  :condition (and (at start (started o7))(at start (made p2)))
