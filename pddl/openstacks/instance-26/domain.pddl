(define (domain socs2025_openstacks_18-domain)
 (:requirements :strips :typing :numeric-fluents :durative-actions)
 (:types order product)
 (:constants
   p19 p7 p12 p17 p2 p10 p4 p6 p15 p22 p13 p20 p14 p21 p1 p5 p11 p3 p8 p9 p18 p16 - product
   o2 o15 o10 o18 o20 o16 o6 o1 o17 o3 o11 o12 o19 o13 o22 o14 o4 o7 o21 o5 o9 o8 - order
 )
 ...
 (:durative-action make_product_p1
  ...
  :condition (and (at start (not_made p1))(at start (started o15)))
 ...
 (:durative-action make_product_p3
  ...
  :condition (and (at start (not_made p3))(at start (started o9))(at start (started o12))(at start (started o13)))
  :effect (and (at start (not (not_made p3))) (at end (made p3))))
 (:durative-action make_product_p4
  :parameters ()
  :duration (= ?duration 60)
  :condition (and (at start (not_made p4))(at start (started o10)))
  :effect (and (at start (not (not_made p4))) (at end (made p4))))
 (:durative-action make_product_p5
  :parameters ()
  :duration (= ?duration 80)
  :condition (and (at start (not_made p5))(at start (started o20)))
  :effect (and (at start (not (not_made p5))) (at end (made p5))))
 (:durative-action make_product_p6
  :parameters ()
  :duration (= ?duration 40)
  :condition (and (at start (not_made p6))(at start (started o13)))
  :effect (and (at start (not (not_made p6))) (at end (made p6))))
 (:durative-action make_product_p7
  :parameters ()
  :duration (= ?duration 90)
  :condition (and (at start (not_made p7))(at start (started o3))(at start (started o13)))
  :effect (and (at start (not (not_made p7))) (at end (made p7))))
 (:durative-action make_product_p8
  :parameters ()
  :duration (= ?duration 40)
  :condition (and (at start (not_made p8))(at start (started o8))(at start (started o13))(at start (started o20)))
  :effect (and (at start (not (not_made p8))) (at end (made p8))))
 (:durative-action make_product_p9
  :parameters ()
  :duration (= ?duration 30)
  :condition (and (at start (not_made p9))(at start (started o1))(at start (started o13)))
  :effect (and (at start (not (not_made p9))) (at end (made p9))))
 (:durative-action make_product_p10
  :parameters ()
  :duration (= ?duration 100)
  :condition (and (at start (not_made p10))(at start (started o4))(at start (started o14)))
  :effect (and (at start (not (not_made p10))) (at end (made p10))))
 (:durative-action make_product_p11
  :parameters ()
  :duration (= ?duration 100)
  :condition (and (at start (not_made p11))(at start (started o9))(at start (started o16)))
  :effect (and (at start (not (not_made p11))) (at end (made p11))))
 (:durative-action make_product_p12
  :parameters ()
  :duration (= ?duration 60)
  :condition (and (at start (not_made p12))(at start (started o6))(at start (started o7))(at start (started o8)))
