(define (domain socs2025_openstacks_24-domain)
 (:requirements :strips :typing :numeric-fluents :durative-actions)
 (:types order product)
 (:constants
   p19 p26 p7 p12 p17 p2 p10 p4 p6 p15 p24 p22 p28 p13 p20 p25 p14 p21 p27 p1 p5 p11 p3 p8 p9 p18 p23 p16 - product
   o2 o10 o15 o18 o20 o16 o25 o6 o1 o23 o17 o3 o11 o12 o19 o26 o13 o22 o24 o14 o27 o4 o7 o21 o5 o9 o8 o28 - order
 )
 ...
 (:durative-action make_product_p1
  ...
  :condition (and (at start (not_made p1))(at start (started o7))(at start (started o9)))
 ...
 (:durative-action make_product_p11
  ...
  :condition (and (at start (not_made p11))(at start (started o20))(at start (started o22))(at start (started o24)))
  :effect (and (at start (not (not_made p11))) (at end (made p11))))
 (:durative-action make_product_p12
  :parameters ()
  :duration (= ?duration 70)
  :condition (and (at start (not_made p12))(at start (started o4))(at start (started o12))(at start (started o14))(at start (started o22))(at start (started o24)))
  :effect (and (at start (not (not_made p12))) (at end (made p12))))
 (:durative-action make_product_p13
  :parameters ()
  :duration (= ?duration 60)
  :condition (and (at start (not_made p13))(at start (started o11))(at start (started o15)))
  :effect (and (at start (not (not_made p13))) (at end (made p13))))
 (:durative-action make_product_p14
  :parameters ()
  :duration (= ?duration 80)
  :condition (and (at start (not_made p14))(at start (started o2)))
  :effect (and (at start (not (not_made p14))) (at end (made p14))))
 (:durative-action make_product_p15
  :parameters ()
  :duration (= ?duration 100)
  :condition (and (at start (not_made p15))(at start (started o8))(at start (started o13))(at start (started o28)))
  :effect (and (at start (not (not_made p15))) (at end (made p15))))
 (:durative-action make_product_p16
  :parameters ()
  :duration (= ?duration 80)
  :condition (and (at start (not_made p16))(at start (started o17))(at start (started o22)))
  :effect (and (at start (not (not_made p16))) (at end (made p16))))
 (:durative-action make_product_p17
  :parameters ()
  :duration (= ?duration 100)
  :condition (and (at start (not_made p17))(at start (started o3)))
  :effect (and (at start (not (not_made p17))) (at end (made p17))))
 (:durative-action make_product_p18
  :parameters ()
  :duration (= ?duration 70)
  :condition (and (at start (not_made p18))(at start (started o26)))
  :effect (and (at start (not (not_made p18))) (at end (made p18))))
 (:durative-action make_product_p19
  :parameters ()
  :duration (= ?duration 30)
  :condition (and (at start (not_made p19))(at start (started o1))(at start (started o24)))
  :effect (and (at start (not (not_made p19))) (at end (made p19))))
 (:durative-action make_product_p20
  :parameters ()
  :duration (= ?duration 40)
  :condition (and (at start (not_made p20))(at start (started o18)))
  :effect (and (at start (not (not_made p20))) (at end (made p20))))
 (:durative-action make_product_p21
  :parameters ()
  :duration (= ?duration 90)
  :condition (and (at start (not_made p21))(at start (started o14))(at start (started o21)))
  :effect (and (at start (not (not_made p21))) (at end (made p21))))
 (:durative-action make_product_p22
  :parameters ()
  :duration (= ?duration 90)
  :condition (and (at start (not_made p22))(at start (started o3))(at start (started o14))(at start (started o23)))
 ...
 (:durative-action ship_order_o1
  :parameters ()
  :duration (= ?duration 1)
  :condition (and (at start (started o1))(at start (made p19))(at start (made p24)))
