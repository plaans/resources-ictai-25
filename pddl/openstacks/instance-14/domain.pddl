(define (domain socs2025_openstacks_6-domain)
 (:requirements :strips :typing :numeric-fluents :durative-actions)
 (:types order product)
 (:constants
   p7 p2 p10 p1 p5 p3 p6 p8 p9 p4 - product
   o2 o3 o10 o6 o1 o4 o7 o5 o9 o8 - order
 )
 ...
 (:durative-action make_product_p1
  ...
  :condition (and (at start (not_made p1))(at start (started o3))(at start (started o9)))
  :effect (and (at start (not (not_made p1))) (at end (made p1))))
 (:durative-action make_product_p2
  :parameters ()
  :duration (= ?duration 40)
  :condition (and (at start (not_made p2))(at start (started o2)))
  :effect (and (at start (not (not_made p2))) (at end (made p2))))
 (:durative-action make_product_p3
  :parameters ()
  :duration (= ?duration 60)
  :condition (and (at start (not_made p3))(at start (started o5))(at start (started o8)))
 ...
 (:durative-action make_product_p5
  :parameters ()
  :duration (= ?duration 40)
  :condition (and (at start (not_made p5))(at start (started o6))(at start (started o7)))
