(define (domain socs2025_openstacks_10-domain)
 (:requirements :strips :typing :numeric-fluents :durative-actions)
 (:types order product)
 (:constants
   p7 p12 p14 p2 p10 p1 p5 p11 p3 p6 p8 p9 p4 p13 - product
   o2 o3 o10 o11 o12 o13 o14 o6 o1 o4 o7 o5 o9 o8 - order
 )
 ...
 (:durative-action make_product_p14
  :parameters ()
  :duration (= ?duration 50)
  :condition (and (at start (not_made p14))(at start (started o1)))
