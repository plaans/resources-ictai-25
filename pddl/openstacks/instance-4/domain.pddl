(define (domain socs2025_openstacks_14-domain)
 (:requirements :strips :typing :numeric-fluents :durative-actions)
 (:types order product)
 (:constants
   p7 p12 p17 p2 p10 p4 p6 p15 p13 p14 p1 p5 p11 p3 p8 p9 p18 p16 - product
   o2 o15 o10 o18 o16 o6 o1 o17 o3 o11 o12 o13 o14 o4 o7 o5 o9 o8 - order
 )
 ...
 (:durative-action make_product_p12
  :parameters ()
  :duration (= ?duration 50)
  :condition (and (at start (not_made p12))(at start (started o11)))
  :effect (and (at start (not (not_made p12))) (at end (made p12))))
 (:durative-action make_product_p13
  :parameters ()
  :duration (= ?duration 10)
  :condition (and (at start (not_made p13))(at start (started o3))(at start (started o5))(at start (started o11))(at start (started o12)))
  :effect (and (at start (not (not_made p13))) (at end (made p13))))
 (:durative-action make_product_p14
  :parameters ()
  :duration (= ?duration 10)
  :condition (and (at start (not_made p14))(at start (started o15))(at start (started o16)))
 ...
 (:durative-action ship_order_o17
  :parameters ()
  :duration (= ?duration 1)
  :condition (and (at start (started o17))(at start (made p5))(at start (made p7)))
  :effect (and (at start (not (started o17))) (at end (shipped o17)) (at end (decrease (stacks_in_use) 1))))
 (:durative-action ship_order_o18
  :parameters ()
  :duration (= ?duration 1)
  :condition (and (at start (started o18))(at start (made p8))(at start (made p18)))
