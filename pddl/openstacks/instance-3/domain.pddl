(define (domain socs2025_openstacks_15-domain)
 (:requirements :strips :typing :numeric-fluents :durative-actions)
 (:types order product)
 (:constants
   p19 p7 p12 p17 p2 p10 p4 p6 p15 p13 p14 p1 p5 p11 p3 p8 p9 p18 p16 - product
   o2 o10 o15 o18 o16 o6 o1 o17 o3 o11 o12 o19 o13 o14 o4 o7 o5 o9 o8 - order
 )
 ...
 (:durative-action make_product_p1
  ...
  :condition (and (at start (not_made p1))(at start (started o8)))
  :effect (and (at start (not (not_made p1))) (at end (made p1))))
 (:durative-action make_product_p2
  :parameters ()
  :duration (= ?duration 70)
  :condition (and (at start (not_made p2))(at start (started o7)))
  :effect (and (at start (not (not_made p2))) (at end (made p2))))
 (:durative-action make_product_p3
  :parameters ()
  :duration (= ?duration 90)
  :condition (and (at start (not_made p3))(at start (started o4))(at start (started o10)))
 ...
 (:durative-action ship_order_o13
  :parameters ()
  :duration (= ?duration 1)
  :condition (and (at start (started o13))(at start (made p15))(at start (made p19)))
  :effect (and (at start (not (started o13))) (at end (shipped o13)) (at end (decrease (stacks_in_use) 1))))
 (:durative-action ship_order_o14
  :parameters ()
  :duration (= ?duration 1)
  :condition (and (at start (started o14))(at start (made p9))(at start (made p16)))
 ...
 (:durative-action ship_order_o16
  :parameters ()
  :duration (= ?duration 1)
  :condition (and (at start (started o16))(at start (made p12))(at start (made p14)))
 ...
 (:durative-action ship_order_o18
  :parameters ()
  :duration (= ?duration 1)
  :condition (and (at start (started o18))(at start (made p15)))
