(define (domain socs2025_openstacks_21-domain)
 (:requirements :strips :typing :numeric-fluents :durative-actions)
 (:types order product)
 (:constants
   p19 p7 p12 p17 p2 p10 p4 p6 p15 p24 p22 p13 p20 p25 p14 p21 p1 p5 p11 p3 p8 p9 p18 p23 p16 - product
   o2 o10 o15 o18 o20 o16 o25 o6 o1 o23 o17 o3 o11 o12 o19 o13 o22 o24 o14 o4 o7 o21 o5 o9 o8 - order
 )
 ...
 (:durative-action make_product_p1
  ...
  :condition (and (at start (not_made p1))(at start (started o3))(at start (started o10)))
  :effect (and (at start (not (not_made p1))) (at end (made p1))))
 (:durative-action make_product_p2
  :parameters ()
  :duration (= ?duration 10)
  :condition (and (at start (not_made p2))(at start (started o2))(at start (started o4)))
  :effect (and (at start (not (not_made p2))) (at end (made p2))))
 (:durative-action make_product_p3
  :parameters ()
  :duration (= ?duration 40)
  :condition (and (at start (not_made p3))(at start (started o9)))
  :effect (and (at start (not (not_made p3))) (at end (made p3))))
 (:durative-action make_product_p4
  :parameters ()
  :duration (= ?duration 10)
  :condition (and (at start (not_made p4))(at start (started o3))(at start (started o15)))
  :effect (and (at start (not (not_made p4))) (at end (made p4))))
 (:durative-action make_product_p5
  :parameters ()
  :duration (= ?duration 80)
  :condition (and (at start (not_made p5))(at start (started o16)))
 ...
 (:durative-action make_product_p7
  ...
  :condition (and (at start (not_made p7))(at start (started o3)))
  :effect (and (at start (not (not_made p7))) (at end (made p7))))
 (:durative-action make_product_p8
  :parameters ()
  :duration (= ?duration 90)
  :condition (and (at start (not_made p8))(at start (started o8))(at start (started o12)))
  :effect (and (at start (not (not_made p8))) (at end (made p8))))
 (:durative-action make_product_p9
  :parameters ()
  :duration (= ?duration 50)
  :condition (and (at start (not_made p9))(at start (started o17))(at start (started o21)))
 ...
 (:durative-action ship_order_o1
  :parameters ()
  :duration (= ?duration 1)
  :condition (and (at start (started o1))(at start (made p12)))
 ...
 (:durative-action ship_order_o3
  :parameters ()
  :duration (= ?duration 1)
  :condition (and (at start (started o3))(at start (made p1))(at start (made p4))(at start (made p7))(at start (made p13)))
