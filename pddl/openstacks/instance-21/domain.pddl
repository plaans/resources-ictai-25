(define (domain socs2025_openstacks_5-domain)
 (:requirements :strips :typing :numeric-fluents :durative-actions)
 (:types order product)
 (:constants
   p7 p2 p1 p5 p3 p6 p8 p9 p4 - product
   o2 o3 o6 o1 o4 o7 o5 o9 o8 - order
 )
 ...
 (:durative-action make_product_p4
  :parameters ()
  :duration (= ?duration 70)
  :condition (and (at start (not_made p4))(at start (started o2))(at start (started o3))(at start (started o4))(at start (started o8)))
  :effect (and (at start (not (not_made p4))) (at end (made p4))))
 (:durative-action make_product_p5
  :parameters ()
  :duration (= ?duration 20)
  :condition (and (at start (not_made p5))(at start (started o1))(at start (started o7))(at start (started o9)))
  :effect (and (at start (not (not_made p5))) (at end (made p5))))
 (:durative-action make_product_p6
  :parameters ()
  :duration (= ?duration 70)
  :condition (and (at start (not_made p6))(at start (started o3)))
 ...
 (:durative-action make_product_p8
  ...
  :condition (and (at start (not_made p8))(at start (started o2)))
 ...
 (:durative-action ship_order_o6
  :parameters ()
  :duration (= ?duration 1)
  :condition (and (at start (started o6))(at start (made p1))(at start (made p2))(at start (made p9)))
 ...
 (:durative-action ship_order_o8
  :parameters ()
  :duration (= ?duration 1)
  :condition (and (at start (started o8))(at start (made p3))(at start (made p4)))
  :effect (and (at start (not (started o8))) (at end (shipped o8)) (at end (decrease (stacks_in_use) 1))))
 (:durative-action ship_order_o9
  :parameters ()
  :duration (= ?duration 1)
  :condition (and (at start (started o9))(at start (made p5)))
