(define (domain socs2025_openstacks_13-domain)
 (:requirements :strips :typing :numeric-fluents :durative-actions)
 (:types order product)
 (:constants
   p7 p12 p14 p17 p2 p10 p1 p5 p11 p3 p6 p8 p15 p9 p4 p13 p16 - product
   o17 o2 o3 o10 o15 o11 o12 o16 o13 o6 o1 o14 o4 o7 o5 o9 o8 - order
 )
 ...
 (:durative-action make_product_p2
  ...
  :condition (and (at start (not_made p2))(at start (started o4)))
  :effect (and (at start (not (not_made p2))) (at end (made p2))))
 (:durative-action make_product_p3
  :parameters ()
  :duration (= ?duration 40)
  :condition (and (at start (not_made p3))(at start (started o2))(at start (started o10)))
  :effect (and (at start (not (not_made p3))) (at end (made p3))))
 (:durative-action make_product_p4
  :parameters ()
  :duration (= ?duration 20)
  :condition (and (at start (not_made p4))(at start (started o7)))
  :effect (and (at start (not (not_made p4))) (at end (made p4))))
 (:durative-action make_product_p5
  :parameters ()
  :duration (= ?duration 100)
  :condition (and (at start (not_made p5))(at start (started o5))(at start (started o11)))
 ...
 (:durative-action make_product_p7
  ...
  :condition (and (at start (not_made p7))(at start (started o5))(at start (started o6))(at start (started o8)))
  :effect (and (at start (not (not_made p7))) (at end (made p7))))
 (:durative-action make_product_p8
  :parameters ()
  :duration (= ?duration 100)
  :condition (and (at start (not_made p8))(at start (started o9))(at start (started o16)))
  :effect (and (at start (not (not_made p8))) (at end (made p8))))
 (:durative-action make_product_p9
  :parameters ()
  :duration (= ?duration 100)
  :condition (and (at start (not_made p9))(at start (started o12)))
  :effect (and (at start (not (not_made p9))) (at end (made p9))))
 (:durative-action make_product_p10
  :parameters ()
  :duration (= ?duration 80)
  :condition (and (at start (not_made p10))(at start (started o2)))
 ...
 (:durative-action ship_order_o11
  :parameters ()
  :duration (= ?duration 1)
  :condition (and (at start (started o11))(at start (made p5))(at start (made p17)))
  :effect (and (at start (not (started o11))) (at end (shipped o11)) (at end (decrease (stacks_in_use) 1))))
 (:durative-action ship_order_o12
  :parameters ()
  :duration (= ?duration 1)
  :condition (and (at start (started o12))(at start (made p9)))
 ...
 (:durative-action ship_order_o14
  :parameters ()
  :duration (= ?duration 1)
  :condition (and (at start (started o14))(at start (made p15)))
  :effect (and (at start (not (started o14))) (at end (shipped o14)) (at end (decrease (stacks_in_use) 1))))
 (:durative-action ship_order_o15
  :parameters ()
  :duration (= ?duration 1)
  :condition (and (at start (started o15))(at start (made p1))(at start (made p13)))
