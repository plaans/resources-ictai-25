(define (domain socs2025_openstacks_4-domain)
 (:requirements :strips :typing :numeric-fluents :durative-actions)
 (:types order product)
 (:constants
   p7 p2 p1 p5 p3 p6 p8 p4 - product
   o2 o3 o6 o1 o4 o7 o5 o8 - order
 )
 ...
 (:durative-action make_product_p1
  ...
  :condition (and (at start (not_made p1))(at start (started o1))(at start (started o6))(at start (started o7)))
 ...
 (:durative-action make_product_p5
  ...
  :condition (and (at start (not_made p5))(at start (started o2)))
