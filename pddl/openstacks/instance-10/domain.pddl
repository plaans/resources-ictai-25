(define (domain socs2025_openstacks_22-domain)
 (:requirements :strips :typing :numeric-fluents :durative-actions)
 (:types order product)
 (:constants
   p19 p26 p7 p12 p17 p2 p10 p4 p6 p15 p24 p22 p13 p20 p25 p14 p21 p1 p5 p11 p3 p8 p9 p18 p23 p16 - product
   o7 o2 o15 o10 o18 o20 o16 o25 o6 o1 o23 o17 o3 o11 o12 o19 o13 o22 o24 o14 o4 o26 o21 o5 o9 o8 - order
 )
 ...
 (:durative-action make_product_p24
  :parameters ()
  :duration (= ?duration 60)
  :condition (and (at start (not_made p24))(at start (started o9)))
  :effect (and (at start (not (not_made p24))) (at end (made p24))))
 (:durative-action make_product_p25
  :parameters ()
  :duration (= ?duration 100)
  :condition (and (at start (not_made p25))(at start (started o7))(at start (started o9)))
  :effect (and (at start (not (not_made p25))) (at end (made p25))))
 (:durative-action make_product_p26
  :parameters ()
  :duration (= ?duration 50)
  :condition (and (at start (not_made p26))(at start (started o21)))
  :effect (and (at start (not (not_made p26))) (at end (made p26))))
 (:durative-action ship_order_o1
  :parameters ()
  :duration (= ?duration 1)
  :condition (and (at start (started o1))(at start (made p11))(at start (made p13)))
 ...
 (:durative-action ship_order_o3
  :parameters ()
  :duration (= ?duration 1)
  :condition (and (at start (started o3))(at start (made p8))(at start (made p12)))
  :effect (and (at start (not (started o3))) (at end (shipped o3)) (at end (decrease (stacks_in_use) 1))))
 (:durative-action ship_order_o4
  :parameters ()
  :duration (= ?duration 1)
  :condition (and (at start (started o4))(at start (made p21)))
