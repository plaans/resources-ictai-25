(define (domain socs2025_openstacks_19-domain)
 (:requirements :strips :typing :numeric-fluents :durative-actions)
 (:types order product)
 (:constants
   p19 p7 p12 p17 p2 p10 p4 p6 p15 p22 p13 p20 p14 p21 p1 p5 p11 p3 p8 p9 p18 p23 p16 - product
   o2 o10 o15 o18 o20 o16 o6 o1 o23 o17 o3 o11 o12 o19 o22 o13 o14 o4 o7 o21 o5 o9 o8 - order
 )
 ...
 (:durative-action make_product_p12
  :parameters ()
  :duration (= ?duration 70)
  :condition (and (at start (not_made p12))(at start (started o10))(at start (started o12))(at start (started o19)))
  :effect (and (at start (not (not_made p12))) (at end (made p12))))
 (:durative-action make_product_p13
  :parameters ()
  :duration (= ?duration 100)
  :condition (and (at start (not_made p13))(at start (started o22)))
 ...
 (:durative-action ship_order_o4
  :parameters ()
  :duration (= ?duration 1)
  :condition (and (at start (started o4))(at start (made p6))(at start (made p7)))
  :effect (and (at start (not (started o4))) (at end (shipped o4)) (at end (decrease (stacks_in_use) 1))))
 (:durative-action ship_order_o5
  :parameters ()
  :duration (= ?duration 1)
  :condition (and (at start (started o5))(at start (made p14))(at start (made p21)))
 ...
 (:durative-action ship_order_o22
  :parameters ()
  :duration (= ?duration 1)
  :condition (and (at start (started o22))(at start (made p4))(at start (made p13)))
