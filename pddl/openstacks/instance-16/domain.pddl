(define (domain socs2025_openstacks_8-domain)
 (:requirements :strips :typing :numeric-fluents :durative-actions)
 (:types order product)
 (:constants
   p7 p12 p2 p10 p1 p5 p11 p3 p6 p8 p9 p4 - product
   o2 o3 o10 o11 o12 o6 o1 o4 o7 o5 o9 o8 - order
 )
 ...
 (:durative-action make_product_p1
  ...
  :condition (and (at start (not_made p1))(at start (started o10)))
 ...
 (:durative-action make_product_p4
  ...
  :condition (and (at start (not_made p4))(at start (started o3))(at start (started o4))(at start (started o8)))
  :effect (and (at start (not (not_made p4))) (at end (made p4))))
 (:durative-action make_product_p5
  :parameters ()
  :duration (= ?duration 10)
  :condition (and (at start (not_made p5))(at start (started o11)))
  :effect (and (at start (not (not_made p5))) (at end (made p5))))
 (:durative-action make_product_p6
  :parameters ()
  :duration (= ?duration 50)
  :condition (and (at start (not_made p6))(at start (started o5))(at start (started o8))(at start (started o12)))
 ...
 (:durative-action make_product_p8
  :parameters ()
  :duration (= ?duration 100)
  :condition (and (at start (not_made p8))(at start (started o10)))
  :effect (and (at start (not (not_made p8))) (at end (made p8))))
 (:durative-action make_product_p9
  :parameters ()
  :duration (= ?duration 100)
  :condition (and (at start (not_made p9))(at start (started o5)))
 ...
 (:durative-action make_product_p11
  ...
  :condition (and (at start (not_made p11))(at start (started o2))(at start (started o6))(at start (started o7))(at start (started o9))(at start (started o11)))
 ...
 (:durative-action ship_order_o2
  :parameters ()
  :duration (= ?duration 1)
  :condition (and (at start (started o2))(at start (made p10))(at start (made p11)))
  :effect (and (at start (not (started o2))) (at end (shipped o2)) (at end (decrease (stacks_in_use) 1))))
 (:durative-action ship_order_o3
  :parameters ()
  :duration (= ?duration 1)
  :condition (and (at start (started o3))(at start (made p4)))
